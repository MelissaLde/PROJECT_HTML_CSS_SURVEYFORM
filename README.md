# Web Design Projects - Build a Survey Form

## Project to train my HTML5/CSS3 skillz with forms

### I. Install Guide
a) Clone the project to your local machine
```sh
git clone https://github.com/MelissaLde/PROJECT_HTML_CSS_SURVEYFORM.git
```
